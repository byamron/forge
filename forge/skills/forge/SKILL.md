...
Use ⚠ for any metric with gaps or issues. If `context_health.over_budget` is true, mark CLAUDE.md with ⚠. If `context_health.demotion_candidates` > 0, add a row showing the count with ⚠.
