...
<!-- Draft generated by Noticed — test and iterate -->
...
def build_proposals(config: Dict, transcripts: Dict, memory: Dict,
    ...
    # Skip decay: proposals skipped 3+ times across /noticed runs auto-dismiss
...
def main():
    parser = argparse.ArgumentParser(
        description="Build proposals from Noticed analysis results"
    )
